...
class ItemMap {
   ...
   */
  constructor(entry: Element, query_str: string, {ignore_case = true, ignore_accents = true, regex = false}) {
 ...
 */
function exec_search(fetch_data = fetchData(), search_result_container_map: {id: string, heading: string, entries: string}, search_result_entry_map: {id: string, title: string, date: string, content: string}, search_input: {id: string, text: string, ignore_case: string, ignore_accents: string, regex: string, button: string}) {
